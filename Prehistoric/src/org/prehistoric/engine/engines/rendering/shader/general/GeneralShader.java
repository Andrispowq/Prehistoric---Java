...
{
    private static GeneralShader instance = null;
    
    public static GeneralShader GetInstance()
    {
	if(instance == null)
	    instance = new GeneralShader();
	
	return instance;
    }
    
    protected GeneralShader()
    {
	super();
	
	AddVertexShader(ResourceLoader.LoadShader("shaders/general/general_VS.glsl"));
