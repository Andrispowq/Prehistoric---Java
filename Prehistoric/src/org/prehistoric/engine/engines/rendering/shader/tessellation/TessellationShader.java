package org.prehistoric.engine.engines.rendering.shader.tessellation;
...
public class TessellationShader extends Shader
{
    private static TessellationShader instance = null;
    
    public static TessellationShader GetInstance()
    {
	if(instance == null)
	    instance = new TessellationShader();
	
	return instance;
    }
    
    protected TessellationShader()
    {
	super();
	
	AddVertexShader(ResourceLoader.LoadShader("shaders/tessellation/tessellation_VS.glsl"));
	AddTessellationControlShader(ResourceLoader.LoadShader("shaders/tessellation/tessellation_TC.glsl"));
	AddTessellationEvaluationShader(ResourceLoader.LoadShader("shaders/tessellation/tessellation_TE.glsl"));
	AddGeometryShader(ResourceLoader.LoadShader("shaders/tessellation/tessellation_GS.glsl"));
	AddFragmentShader(ResourceLoader.LoadShader("shaders/tessellation/tessellation_FS.glsl"));
	...
	SetUniformi("tessellationFactor", EngineConfig.getTessellationFactor());
	SetUniformf("tessellationSlope", EngineConfig.getTessellationSlope());
	SetUniformf("tessellationShift", EngineConfig.getTessellationShift());
